    ...
    return (
        <>
            <div className="col-9 mb-5">
                ...
                <div  className="pb-5 mb-3 pt-1" id="live-challenge">
                ...
                <div id="past-challenge" className="mt-4 pt-5 text-center">
                    ...
                    <div className="row justify-content-around">
                        ...
                        <div className="col-3" id="comp-card">
                            ...
                            <p className="clg-dt">Challenge taken up on Jul 19 ‘21</p>
                            <a href="https://drive.google.com/file/d/12EaehnK1SAD1XnsDDZXOSdWujIhXZ8kG/view?usp=sharing" target="_blank"><button type="button" className="btn btn-primary mb-3" id="ask-btn" ><i className="fa fa-download" aria-hidden="true"></i> Download</button></a>    
                        </div>
                    </div>
                </div>
